...
export default class chromeextwall9 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w3SS_9: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%203%20SS%2FChromeExtentionWallets.mp4?alt=media&token=9ac83d7d-1209-486c-80ba-3b2ba5b2e488`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
