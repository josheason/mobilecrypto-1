...
export default class ultimsec15 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w3SS_15: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%203%20SS%2FUltimateSecurity.mp4?alt=media&token=69c4c9c7-2d08-4680-8a37-a3767228bddc`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.whatexuse14()}>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.w3booklist1()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be going over the levels of security.`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`If you are keeping crypto on a centralized exchange platform, your coins are unsafe. `}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			{`Here are some tips everyone should have before getting into cryptocurrency:`}
			</Text><></>
			<Text style={styles.para}>
			{`1. Get a hardware wallet`}
			</Text><></>
			<Text style={styles.para}>
			{`2. Bookmark the official crypto sites you use`}
			</Text><></>
			<Text style={styles.para}>
			{`3. Get metamask`}
			</Text><></>
			<Text style={styles.para}>
			{`4. Do not trust random URLs`}
			</Text><></>
			<Text style={styles.para}>
			{`5. Always verify that you’ve landed on a legit website`}
			</Text><></>
			<Text style={styles.para}>
			{`6. Do not use brain wallets ( do not try to remember all of your passwords) `}
			</Text><></>	
			<Text style={styles.para}>
			{`7. Install a good ad-blocker`}
			</Text><></>
			<Text style={styles.para}>
			{`8. Do not trust slack DMs `}
			</Text><></>
			<Text style={styles.para}>
			{`9. Clean out your history`}
			</Text><></>
			<Text style={styles.para}>
			{`10. Don’t unlock your account to check your balance`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Now, let’s go deeper into ways to be more secure. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`If you are able to, get a dedicated device for cryptocurrency. `}
			</Text><></>
			<Text style={styles.para}>
			{`This device should be clean and encrypted.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Do not do anything else on your dedicated device; do not connect other devices to it; do not casually browse on it. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Keepass: This will store your passwords for you `}
			</Text><></>
			<Text style={styles.para}>
			{`Data Encryption: Linux`}
			</Text><></>
			<Text style={styles.para}>
			{`2-Factor Authentication: Google Authenticator, Fido U2f`}
			</Text><></>
			<Text style={styles.para}>
			{`Phone number: Your sim card can be ported. Call cell phone carrier and add “ do not port”`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Browser: Privacy badger, Ublock Origin `}
			</Text><></>
			<Text style={styles.para}>
			{`Email: Proton mail `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`1. Disable and remove stand alone Adobe Flashplayer`}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			{`4. Be cautious of clicking random links `}
			</Text><></>
			<Text style={styles.para}>
			{`5. Never print on dedicated device  ( this is because printers can store information) `}
			</Text><></>
			<Text style={styles.para}>
			{`6. Use separate network for guests `}
			</Text><></>
			<Text style={styles.para}>
			{`7. Use messaging platforms with end to end encryption, such as: Signal or Wire.  `}
			</Text><></>
			<Text style={styles.para}>
			{`8. Do not hold crypto on centralized exchanges `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Ultimately, I urge you all to practice good habits on the computer; I do not want you to get hacked. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Ledger: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://shop.ledger.com/pages/ledger-nano-x?r=70227f7a8962`)}>{`https://shop.ledger.com/pages/ledger-nano-x?r=70227f7a8962`}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Ledger One: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://shop.trezor.io/product/trezor-one-black?offer_id=35&aff_id=3810`)}>{`https://shop.trezor.io/product/trezor-one-black?offer_id=35&aff_id=3810`}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Purism: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://puri.sm/`)}>{`https://puri.sm/`}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Cheap laptop: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://amzn.to/3cnGKpJ`)}>{`https://amzn.to/3cnGKpJ`}</Text><></>
			</Text><></>
