...
export default class coinbase3 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w3SS_3: true})
        		})
        		batch.commit().then(() => {
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.sendcrypto2()}>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.details4()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we are going to talk about how to create a Coinbase account. `}
			</Text><></>
			<Text style={styles.para}>
			{`Coinbase is going to be the median exchange to get your US Dollars into cryptocurrency.`}
			</Text><></>
			<Text style={styles.para}>
			{`If you have a bank account, you will be able to hook it up to Coinbase; however, if you do not, you can use a credit card or local bitcoin, to use cash. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Now, I am going to show you how to make your money back, from buying this course.`}
			</Text><></>
			<Text style={styles.para}>
			{`Go on Coinbase earn (coinbase.com/earn)  and watch their videos; by doing this, you will be able to make $130 worth of cryptocurrency.`}
			</Text><></>
			<Text style={styles.para}>
			{`Additionally, you can make money from referring friends, or using a referral code. This will earn you $10 each time. `}
			</Text><></>
			<Text style={styles.italPara}>
			{`This is free money; do not miss out.`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`If you are doubtful about making commissions from Coinbase referrals, I am living proof; I’ve made hundreds of dollars from referrals by inviting people to Coinbase.`}
			</Text><></>
			<Text style={styles.para}>
			{`Currently Bitcoin is down; however, when Bitcoin goes up, you can start spreading your referral code and make $100 bucks, easily.`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Let’s jump into how Coinbase works.`}
			</Text><></>
			<Text style={styles.para}>
			{`You will have to go through KYC; here you will have to enter your personal information, such as:  drivers license, zip code, address. This is because they must keep track of your cryptocurrency, to ensure you are not laundering money, or partaking in any illegal activity. `}
			</Text><></>
			<Text style={styles.para}>
			{`Coinbase is great because, if you have US dollars, there's $100,000 insurance; if it were to get hacked, you would be covered for that amount.`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`If you would like assistance, I am offering 5 free strategy sessions; during these sessions I will break down an investment strategy for you, in your currency financial situation. Of course, it will be based on my opinion and the decision is ultimately yours. `}
			</Text><></>
			<Text style={styles.italPara}>
			{`This service will be provided at a fixed fee. `}
			</Text><></>
			<Text style={styles.para}>
			{`I only recommend doing this if you are serious about cryptocurrency; if you are just getting started, you can put a couple hundred bucks in, buy Bitcoin, and watch my YouTube channel for tips. `}
			</Text><></>
			<Text style={styles.para}>
			{`If you have any questions about the course, message me. I am open to making edits, new videos, and going into more detail on certain things by popular demand. `}
			</Text><></>
			<Text style={styles.para}>
			{`Once you have access to this course, you have it for life. You will be able to receive new content over time. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
