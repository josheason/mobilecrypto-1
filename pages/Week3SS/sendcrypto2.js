...
export default class sendcrypto2 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w3SS_2: true})
        		})
        		batch.commit().then(() => {
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today I will be showing you how to send transactions across the blockchain. `}
			</Text><></>
			<Text style={styles.para}>
			{`This is going to be tutorial-style. `}
			</Text><></>	
			<Text style={styles.para}>
			{`I will show you how to switch REN, my current cryptocurrency, into Dash.`}
			</Text><></>	
			<Text style={styles.para}>
			{`Turn your attention to the screen (0:59)`}
			</Text><></>
