...
export default class coinbasepro5 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w3SS_5: true})
        		})
        		batch.commit().then(() => {
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.bintut6()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be discussing Coinbase pro, which is basically an extension of Coinbase.`}
			</Text><></>
			<Text style={styles.para}>
			{`This video will be tutorial style and I will be showing you how to maneuver and send coins on Coinbase pro. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Once you have an Coinbase account open, all you have to do is google Coinbase pro and you should find it (I will leave a link below as well).  This will give you access to the trading platform.`}
			</Text><></>
			<Text style={styles.para}>
			{`What are the benefits of this trading platform? It gives you access to all of the coins, you can trade it and seamlessly transfer the money with very cheap fees. `}
			</Text><></>
			<Text style={styles.para}>
			{`I am going to send coins back and forth to show you how it works`}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Create a Coinbase Account:`}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://www.coinbase.com/join/560ee0e70c80e251ea000192`)}>{`https://www.coinbase.com/join/560ee0e70c80e251ea000192`}</Text><></>
			</Text><></>
