...
export default class body4 extends Component{
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			{`Hey there, you’ve made it to the next video!`}
			</Text><></>
			 <Text style={styles.para}>
			{`Today we will be talking about the body. `}
			</Text><></>
			<Text style={styles.para}>
			{'No, not so you can get six-pack abs; but so you can understand how big of a role the body plays in your daily life. '}
			</Text><></>
			<Text style={styles.para}>
			{'It is vital that I discuss this in week one because it helps lay a strong foundation to build from throughout the rest of the course. '}
			</Text><></>
			<Text style={styles.para}>
			{`Your actions are a representation of what you put into your body.`}
			</Text><></>
			<Text style={styles.para}>
			{`Think of yourself as a car: without fuel it will not go anywhere; with the wrong fuel, it will not function at its full potential. `}
			</Text><></>
			<Text style={styles.para}>
			{`My goal today is to maximize your output by helping you improve your input.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Let’s get started.`}
			</Text><></>	
			...
			<Text style={styles.para}>
			{`Stop eating foods that are hard to digest.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Burgers, fries and pizza will not help you succeed. `}
			</Text><></>
			<Text style={styles.para}>
			{`Your body is directing extra energy toward your digestive system to help break down food. This results in feeling lethargic, or as many of us call “the itis.” In turn, you will not perform well in the tasks you need to complete.  `}
			</Text><></>
			<Text style={styles.para}>
			{`If you eat healthier, you can utilize all of your energy towards being productive.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`Heavy, greasy, high fat foods are slowing you down!   `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Drink Water `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Water helps flush toxins from your body, increases blood flow, and provides mental clarity. `}
			</Text><></>
			<Text style={styles.bolPara}>
			...
			<Text style={styles.para}>
			{`It is important that you know the amount of each nutrient that you must consume daily, according to your body type. `}
			</Text><></>
			<Text style={styles.para}>
			{`Consuming the required amounts will increase your energy levels; however, missing the mark will result in feeling fatigue.  `}
			</Text><></>	
			<Text style = {styles.para}>
			<Text style = {styles.reg}>{'The macros in my diet consist of:'}</Text><></>
			<Text style = {styles.bol}>{'Carbs:'}</Text><></>
			<Text style = {styles.reg}>{' Rice and potatoes.'}</Text><></>
			<Text style = {styles.bol}>{'Fats:'}</Text><></>
			<Text style = {styles.reg}>{' Avocado, olive oil, nuts. '}</Text><></>
			<Text style = {styles.bol}>{'Protein:'}</Text><></>
			<Text style = {styles.reg}>{' Beans, soy, lentils, peas.'}</Text><></>
			</Text><></>	
			<Text style={styles.bolPara}>
			...
			<Text style={styles.para}>
			{` Micronutrients can impact the way you feel, be sure to consume them. They can come from foods, such as dark leafy greens or in the form of supplements. `}
			</Text><></>
			<Text style={styles.para}>
			{` A few supplements that I take are: Pure Himalyan Shilajit (All Natural Upgrades), black cumin oil, black seed oil, raw phytoplankton, chia seeds, and flax seeds. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{` Workout `}
			</Text><></>
			<Text style={styles.para}>
			{` Exercise increases blood flow, releases endorphins, and provides physical and mental  satisfaction.`}
			</Text><></>
			<Text style={styles.para}>
			{` It also gives you mental endurance. If you can put yourself through the physical pain of exercise, it will help you tolerate other tasks that you may not want to do. `}
			</Text><></>
			<Text style={styles.para}>
			{`Reading a book compared to doing a high intensity workout will seem like nothing. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{` Sleep`}
			</Text><></>
			<Text style={styles.para}>
			{` You must achieve 7-8 hours of rest every night.`}
			</Text><></>
			<Text style={styles.para}>
			{` No more, no less.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Lack of sleep and oversleeping can both leave you fatigue throughout the day- hindering your productivity. `}
			</Text><></>
			<Text style={styles.para}>
			{`If you are struggling with falling asleep, or wake up during the night, it is important that you find the underlying issue in order to achieve a full night's sleep. `}
			</Text><></>
			<Text style={styles.para}>
			{`All of the information I have gathered from research and experience will benefit you greatly; however, you must make the effort to do your own research and find what is best for your body type and lifestyle. `}
			</Text><></>
			<Text style={styles.para}>
			{`Paying attention to each of these aspects and treating your body with care will allow you to feel better mentally and physically. In turn, your output efficiency will be maximized. `}
			</Text><></>
			<Text style={styles.para}>
			...
			onPress={() => Linking.openURL('https://anushilajit.com/landing-page')}>
			{'Pure Himalayan Shilajt'}
			</Text><></>
			<Text style={styles.paraURL}
			onPress={() => Linking.openURL('https://www.calculator.net/macro-calculator.html')}>
			{'Macros Calculator'}
			</Text><></>	
