...
export default class sixrules7 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w1_7: true})
        		})
        		batch.commit().then(() => {
	...
	return(
				...
				{'The 6 Rules Of Decision Making'}
				</Text>
			...
			source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%201%2Fsixrules.mp4?alt=media&token=9379f34b-e888-4269-91cb-33afe4c3e940'}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.focus6()}>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.rewire8()}>
		...
		>{
			...
			{`Welcome back!`}
			 ...
			 <Text style={styles.para}>
			{`Life is a series of decisions, from deciding to brush our teeth in the morning to making a big decision in cryptocurrency. `}
			</Text><></>
			<Text style={styles.italPara}>
			{'Each decision is important and can shape your life in some way.'}
			</Text><></>
			<Text style={styles.para}>
			{'The volatile nature of cryptocurrency can amplify your decision making process, this can be beneficial or detrimental to your success. '}
			</Text><></>
			<Text style={styles.para}>
			{`No need to fret, I am going to provide you with six rules to live by when making decisions.`}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Create a constructive environment`}
			</Text><></>
			<Text style={styles.para}>
			{`Decisions can become complex when they involve or affect other people or emotions, so it helps to create a constructive environment.`}
			</Text><></>
			<Text style={styles.para}>
			{`By doing this you will be able to explore the situation and weigh your options.`}
			</Text><></>	
			<Text style={styles.para}>
			{`Here are 3 tips you can use to create a constructive environment `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`3-Day Rule`}
			</Text><></>
			<Text style={styles.para}>
			{`Before making a decision be sure to wait at least 3 days before finalizing it. `}
			</Text><></>
			<Text style={styles.italPara}>
			{`Think in Clarity `}
			</Text><></>
			<Text style={styles.para}>
			{`Get rid of all distractions before making a decision.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`Bias `}
			</Text><></>
			<Text style={styles.para}>
			{`Reflect on where you may have received information, bias can shape the outcome of your decision.`}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Investigate the situation in detail `}
			</Text><></>
			<Text style={styles.para}>
			{`You need to make sure that you fully understand everything about the situation committing to a decision. `}
			</Text><></>
			<Text style={styles.para}>
			{`This means you have to understand the market cycles, big indicators, ratios, etc. in cryptocurrency before making a big leap. `}
			</Text><></>
			<Text style={styles.italPara}>
			...
			<Text style={styles.para}>
			{`Play devil's advocate with yourself and others.  `}
			</Text><></>
			<Text style={styles.para}>
			{`This means you should try to find other coins that are better.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Consider the opposing side to make sure you are selecting the best option. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Select the best solution `}
			</Text><></>
			<Text style={styles.para}>
			{`Look for the best solution based on the information you’ve gathered.`}
			</Text><></>
			<Text style={styles.para}>
			{`Do not make a decision too quickly; however, avoid over-analyzing and procrastinating on a decision. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Evaluate your plan`}
			</Text><></>
			<Text style={styles.para}>
			{`When creating a plan, take as many variables as you possibly can into consideration.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Come up with a strategy before executing your plan. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Communicate your decision and take action`}
			</Text><></>
			<Text style={styles.para}>
			{`Reach out to others for advice before committing to a decision. `}
			</Text><></>
			<Text style={styles.para}>
			{`Having the perspective of others can help provide clarity. `}
			</Text><></>
			<Text style={styles.para}>
			{`Do not neglect the Facebook group, you are encouraged to communicate ideas in the chat; it can help to get advice from members on decisions.  `}
			</Text><></>
			<Text style={styles.para}>
			{`If you apply these rules when making a decision on anything, you will see more positive outcomes.  `}
			</Text><></>
			<Text style={styles.para}>
