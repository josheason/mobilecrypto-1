...
export default class topdownfun2 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w7_2: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%207%2FTopDownFundamentalAnalysis.mp4?alt=media&token=3f314a3a-47ee-4f36-ac71-eac9a09c2af0`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about more fundamental analysis and macro conditions.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`What happens in the world or even your country, will directly impact cryptocurrency, as well as the project.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Make sure you take notes and apply research techniques.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Companies are subject to what occurs in the economy; this may alter your fundamental analysis.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`World→ Country→ Industry→ Crypto→ Ecosystem→ Project  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`The big question we will be answering this week is: How reliant is the industry on a strong economy?  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Some industries are more subject to the health of the economy.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
