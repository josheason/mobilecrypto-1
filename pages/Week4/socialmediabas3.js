...
export default class socialmediabas3 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w4_3: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%204%2FSocialMediaBasics.mp4?alt=media&token=04ee24a5-8325-4fe7-9662-a269f45687e1`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be diving into the social media of cryptocurrencies to analyze their communities.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`With the online nature of cryptocurrency,they rely on perception. It is not like a physical store, where they are able to offer customer service.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Social media is the best place to have a community and one of the best marketing platforms. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`To find a cryptocurrencies social media account: go on their website, scroll down to the bottom and you should see links for Instagram, Twitter, Linkedin, etc.   `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Follow along with me, as I dissect the social media marketing of cryptocurrencies; turn your attention to the screen (1:20) `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
