...
export default class webconvdes6 extends Component{
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.webtraff7()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about website design and how you can weed out coins by looking at their website.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`A website is important because it is where people go to learn about the product and invest in it.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`A company's website is equivalent to a storefront, it has to be visually pleasing and capture the attention of consumers. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`There are 4 factors to pay attention to when looking at a website.  `}
			</Text><></>
			<Text style={styles.para}>
			{`1. First impression/ How does it look? `}
			</Text><></>
			<Text style={styles.para}>
			{`2. How many clicks does it make to reach the main product? `}
			</Text><></>
			<Text style={styles.para}>
			{`3. Are there any videos? `}
			</Text><></>
			<Text style={styles.para}>
			{`4. Does it have a lead capture?  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Follow along with me, as I evaluate what websites are good versus bad; turn your attention to the screen (1:30). `}
			</Text><></>
