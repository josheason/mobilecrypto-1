...
export default class internetwork3 extends Component{
	...
	return(
			...
			source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%202%2Fhowinternetwork.mp4?alt=media&token=2645411b-767b-406a-ab44-2ba7320bff1a'}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.booklistw2()}>
		...
		>{
			...
			{`Welcome back!`}
			 ...
			 <Text style={styles.para}>
			{`Before we dive into internet 3.0, I would like to touch base on how the internet works. `}
			</Text><></>
			<Text style={styles.italPara}>
			{'Here are some key concepts that can help simplify the process'}
			</Text><></>
			<Text style={styles.bolPara}>
			{'Protocol'}
			</Text><></>
			<Text style={styles.para}>
			{`It is a set of rules specifying how computers should communicate with each other over a network. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Packet  `}
			</Text><></>
			<Text style={styles.para}>
			{`Data is sent across the internet as a message; before a message is sent, it is split in many different fragments called packets.  `}
			</Text><></>
			<Text style={styles.para}>
			{`For example, when you send a picture you are essentially sending different pieces of the picture and they all come back together when it reaches its destination. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Packet Routing Network`}
			</Text><></>
			<Text style={styles.para}>
			{`It is a network that routes packets from a source computer to a destination computer.`}
			</Text><></>
			<Text style={styles.para}>
			{`The internet is made up of a massive network of computers called routers. Each router's job is to know how to move packets along from their source to their destination. A packet will have moved through multiple routers during its journey. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Routers originated in the 1960’s as ARPANET, a military project that was striving for a decentralized computer network. By doing this, the government could access and distribute information in the event of a catastrophe. `}
			</Text><></>
			<Text style={styles.para}>
			{`Since then, a number of Internet Service Provider (ISP) corporations have added routers onto ARPANET routers.`}
			</Text><></>
			<Text style={styles.para}>
			{`This means that ISP corporations like Cox, Comcast, AT&T have created their own infrastructure and added it onto the existing routers, this is where the internet became very decentralized`}
			</Text><></>
			<Text style={styles.bolPara}>
			{`IP Address`}
			</Text><></>
			...
			<Text style={styles.para}>
			{`The public IP address will be your router, the private address will be found on your phone or computer (the host). `}
			</Text><></>
			<Text style={styles.para}>
			{`Multiple devices on a local network connected to the internet will share the same public IP address. `}
			</Text><></>
			<Text style={styles.para}>
			{`It travels from Host → Private network → Router+NAT → Internet→ Server `}
			</Text><></>
			<Text style={styles.para}>
			{`The internet is very complex, here are the different layers and what you may be able to find in each of them. `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Surface Web (4%)`}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Here you will find: Google, Bing, Yahoo, Wikipedia, public profiles`}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Deep Web (90%)`}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Here you will find: Craigslist, Reddit, 4chan/ 8chan, Pastebins, niche blogs and forums, yahoo answers`}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Dark Web (6%)`}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Here you will find: Zeronet, I2P, Open Bazaar, Telegram, TOR encrypted sites`}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Peer to Peer Technology (P2P)`}
			</Text><></>
			<Text style={styles.para}>
			{`Relies on individuals, there is no control; here, peers are equally privileged. `}
			</Text><></>
			<Text style={styles.para}>
			{`A network is created when multiple devices are connected and share resources without going through a separate server computer. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`As we progress deeper into the course, I will go more into depth on the internet, but hopefully this helped you get a basic understanding of how the internet works. `}
			</Text><></>
			<Text style={styles.para}>
