...
export default class week2intro1 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w2_1: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%202%2Fintroweek2.mp4?alt=media&token=d226b38c-1c82-4252-becb-ecbbc84524e5'}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			{`Congratulations! You’ve made it to week two. `}
			</Text><></>
			 <Text style={styles.para}>
			{`Coming into this week you should understand productivity, how to manage your time, how to fuel your body, and how to eliminate distractions in order to maximize your output efficiency.  `}
			</Text><></>
			<Text style={styles.para}>
			{'This week we will be getting into the blockchain ecosystem. We will take a deep dive into the history of Bitcoin and Ethereum, the two largest coins in the entire market. '}
			</Text><></>
			<Text style={styles.para}>
			{'I will be providing Bitcoin 101 and 102, in addition to Ethereum 101 and 102.'}
			</Text><></>
			<Text style={styles.para}>
			{`I will explain to you the market cycle. This is one of the most important videos in the whole entire course because it's going to let you know exactly what's going on in cryptocurrency, when to get in and when to get out.`}
			</Text><></>
			<Text style={styles.para}>
			{`Much more is in store this week, but I want to reiterate that you must not skip around this course. Everything is systematically placed. `}
			</Text><></>
			<Text style={styles.para}>
			{`Read the books, be active in the Facebook group, and you will be on track. `}
			</Text><></>
			<Text style={styles.para}>
