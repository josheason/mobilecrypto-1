...
export default class investcrypto10 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w2_10: true})
        		})
        		batch.commit().then(() => {
	...
	return(
				...
				{'How much Money Should You Invest In Cryptocurrrency?'}
				</Text>
