...
export default class eth1027 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w2_7: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%202%2Fethereum102.mp4?alt=media&token=9a11c66d-d7a7-43fc-96e3-8151f4d05e36'}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be deepening our understanding of Ethereum. `}
			</Text><></>
			<Text style={styles.para}>
			{`It is vital that we gain background knowledge on the history of Ethereum, in order to really understand it. `}
			</Text><></>	
			<Text style={styles.para}>
			{`In this video I will be explaining DAO and the DAO attack. `}
			</Text><></>	
			<Text style={styles.para}>
			{` `}
			</Text><></>	
			...
			<Text style={styles.para}>
			{`It stands for Decentralized Autonomous Organization (can also go by DAC: Decentralized Autonomous Corporation).`}
			</Text><></>	
			<Text style={styles.para}>
			{`This method of organization can be viewed as a spider- web; there is no “top down” hierarchy, as seen in traditional organizations.  `}
			</Text><></>	
			<Text style={styles.para}>
			{`Therefore, as long as you have a stake in the organization, you are able to vote for change; like a real democracy. `}
			</Text><></>	
			<Text style={styles.para}>
			{`For example, `}
			</Text><></>	
			<Text style={styles.para}>
			{`If I created Alexcoin and you contributed Ethereum to the coin, you would be able to vote and make changes regarding Alexcoin. `}
			</Text><></>	
			<Text style={styles.para}>
			{` `}
			</Text><></>	
			...
			<Text style={styles.para}>
			{`I will not get into details, this information is not needed for you to make money; however, it is important to understand the principles.`}
			</Text><></>	
			<Text style={styles.para}>
			{`If you are interested, I encourage you to research this yourself. `}
			</Text><></>	
			<Text style={styles.para}>
			{`The DAO launched in April 2016, with a 28-day funding window. `}
			</Text><></>
			<Text style={styles.para}>
			{`They raised $150 million, with 11,000 members.`}
			</Text><></>	
			<Text style={styles.para}>
			{`Keep in mind, this was not a hack. It was within a smart contract; the smart contact was coded incorrectly. `}
			</Text><></>	
			<Text style={styles.para}>
			{`An individual exploited this contract, in turn 50 million of the funds were pushed to a separate smart contract.`}
			</Text><></>	
			<Text style={styles.para}>
			{` `}
			</Text><></>	
			...
			<Text style={styles.para}>
			{`To solve this problem, Ethereum crossed the immutability principle; Ethereum rolled back the blockchain, to reverse the damage. `}
			</Text><></>
			<Text style={styles.para}>
			{`Keep in mind, this is the same control that banks have. When they make mistakes, they are able to solve it in some way.`}
			</Text><></>	
			<Text style={styles.para}>
			{`On the other side of the spectrum, Bitcoin would let this situation play out; they would take no hand in it. `}
			</Text><></>	
			<Text style={styles.para}>
			{` `}
			</Text><></>	
			<Text style={styles.para}>
			{`You can view this as a good or bad thing; when deciding between Bitcoin and Ethereum, it comes to your set of values and perception of the government.`}
			</Text><></>	
			<Text style={styles.para}>
			{`Whatever principles you stand by, make a decision based on what you want to stick with long term.`}
			</Text><></>	
			<Text style={styles.para}>
			{`Personally, I am balanced; I use both Bitcoin and Ethereum because I can agree with values on both sides. `}
			</Text><></>	
			<Text style={styles.para}>
			{`Ultimately, the choice is yours; the material and information you need to come to a conclusion was provided in this video.`}
			</Text><></>	
			<Text style={styles.para}>
			{` `}
			</Text><></>	
