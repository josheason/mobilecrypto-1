...
export default class EssentialReadingList3b extends Component{
	...
	return(
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.HowToUse1()}>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.Bookmarks4c()}>
		...
		>{
          ...
          <Text style = {styles.para}  onPress={() => Linking.openURL('https://amzn.to/34I1fLq')}>
           ...
           <Text style = {styles.para}  onPress={() => Linking.openURL('https://amzn.to/3cqRT9t')}>
			...
			<Text style = {styles.para}>{`Productivity`}</Text><></>
 			   <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2Vxy9dj')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
  			    <Text style={styles.regURL} >{'The One Thing'}</Text><></>
 			   </Text><></>
          <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2XMeKIx')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
  			    <Text style={styles.regURL} >{'The High-Performance Planner'}</Text><></>
 			   </Text><></>
			    <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2z8OFsV')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
 			     <Text style={styles.regURL} >{`The 80/20 Individual`}</Text><></>
			    </Text><></>	 
			<Text style = {styles.para}>{` `}</Text><></>	


			<Text style = {styles.para}>{`Investing`}</Text><></>
 			   <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2RBvZZ4')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
  			    <Text style={styles.regURL} >{'Principles'}</Text><></>
 			   </Text><></>
          <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2yhHQog')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
  			    <Text style={styles.regURL} >{'Rich Dad Poor Dad'}</Text><></>
 			   </Text><></>
			    <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2ygaCFZ')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
 			     <Text style={styles.regURL} >{`The Richest Man in Babylon`}</Text><></>
			    </Text><></>
			    <Text style = {styles.para}  onPress={() => Linking.openURL('https://amzn.to/2ymP8Hb')}>
			      <Text style = {styles.reg}>{`\u2022  `}</Text><></>
			      <Text style={styles.regURL}>{'The Intelligent Investor'}</Text><></>
  			  </Text><></>
			<Text style = {styles.para}>{` `}</Text><></>


			 <Text style = {styles.para}>{`Brain`}</Text><></>
          ...
          <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/3a5JPcs')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
  			    <Text style={styles.regURL} >{'Bitcoin Billionaires '}</Text><></>
 			   </Text><></>
			    <Text style = {styles.para} onPress={() => Linking.openURL('https://amzn.to/2XBI4Bn')}>
 			     <Text style = {styles.reg}>{`\u2022  `}</Text><></>
 			     <Text style={styles.regURL} >{`Life After Google`}</Text><></>
			    </Text><></>
				<Text style = {styles.para}>{` `}</Text><></>     
				     
					
			 <Text style = {styles.para}>{`Marketing Research`}</Text><></>
