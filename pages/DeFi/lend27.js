...
export default class lend27  extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , DEFI_27: true})
        		})
        		batch.commit().then(() => {
	...
	return(
				...
				{'Intro to DeFi Lending and Borrowing'}
				</Text>
			...
			source={{ uri: `https://allthevideostherecanpossiblybeintheworld.s3.amazonaws.com/Intro+to+DeFi+Lending+and+Borrowing.mp4`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.compound26()}>
