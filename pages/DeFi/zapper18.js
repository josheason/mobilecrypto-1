...
export default class zapper18  extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , DEFI_18: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://allthevideostherecanpossiblybeintheworld.s3.amazonaws.com/Overview+of+Zapper.fi.mp4`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.loopring17()}>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.dao19()}>
