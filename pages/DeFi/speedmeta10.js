...
export default class speedmeta10  extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , DEFI_10: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://allthevideostherecanpossiblybeintheworld.s3.amazonaws.com/11Speed+up+TX+in+metamask.mp4`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
