...
export default class TradeUniswap8  extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , DEFI_8: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://allthevideostherecanpossiblybeintheworld.s3.amazonaws.com/8Trading+Simple+Swap+Uniswap.mp4`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.etherscan9()}>
