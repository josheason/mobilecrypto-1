...
export default class DeskMetConnDapp5  extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , DEFI_5: true})
        		})
        		batch.commit().then(() => {
	...
	return(
				...
				{'Desktop Metamask - connecting to dapp dex'}
				</Text>
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.DeFiEco4()}>
