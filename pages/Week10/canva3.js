...
export default class canva3 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w10_3: true})
        		})
        		batch.commit().then(() => {
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.eventbrite4()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about Canva`}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`You do not need a graphic designer, you can easily make your own graphics on Canva.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`It does not take much effort and they provide you with templates, photos, etc to help your design.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Turn your attention to the screen (0:30) to see how to navigate Canva and create a design.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` \u2022 You will want your design to be simple and straightforward. `}
			</Text><></>
			<Text style={styles.para}>
			{` \u2022 You can use colors.co for color schemes. `}
			</Text><></>
			<Text style={styles.para}>
			{` \u2022 Play around with elements, fonts, pictures until your design looks cohesive. `}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Canva: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(` https://www.canva.com/`)}>{` https://www.canva.com/`}</Text><></>
			</Text><></>
