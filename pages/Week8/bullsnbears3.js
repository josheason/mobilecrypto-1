...
export default class bullsnbears3 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w8_3: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%208%2FBullsandTheBears.mp4?alt=media&token=bf012a80-375e-45da-b465-eb6e41f34622`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.masspsych2()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about the bulls and the bears. I will give you an overview on how to predict these markets. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Bull Market: Markets that are setting higher highs and higher lows, showing consistent growth. `}
			</Text><></>
			<Text style={styles.para}>
			{`Bear Market: markets that are setting lower highs and lower lows, showing consistent decline.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`It is very easy to determine whether or not a market is bull or bear; however, how do we determine when it has ended or started? `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` 1. Short, medium, and long term -SMA’s. For bull trends. There are little to no crosses in these SMA’s. Usually, short, is significant above the bull trend and long term is closest. Use 50, 200, and 200 day SMA as examples. This pattern reversed is a bearish trend.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` 1. Bull markets: previous resistance may become new supports `}
			</Text><></>
			<Text style={styles.para}>
			{` 2. Bear markets: previous support may become new resistance  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` 1. Bull market: optimism, mass exuberance, FOMO. `}
			</Text><></>
			<Text style={styles.para}>
			{` 2. Bear market: fear, dread, volatility in volume, FUD. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.bulPara}>
			{`How to call the start of a bull or bear market: `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`V-Top: A long extended rally, then a massive crash gives the start of bear markets  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Significant Crashes: Bear markets are more visible because of significant crashes  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Golden crosses and 20-day EMA: Bull market indicators lag to confirm and aren't as visible as Bear markets; usually 20-day EMA is a good indicator of support as well as golden crosses to indicate the beginning of bull market.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`The usual cycle of a market `}
			</Text><></>
			<Text style={styles.para}>
			{`Bear market→ Accumulation phase→ Bull Market→ Bear Market→ Accumulation phase.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.bolPara}>
			{`Strengths of the bulls and the bears: `}
			</Text><></>
			<Text style={styles.para}>
			{` - Quantifiability `}
			</Text><></>
