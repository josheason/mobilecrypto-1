...
export default class support8 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w8_8: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%208%2FSupportAndResistance.mp4?alt=media&token=e8365a63-e1f4-45fd-86a9-aed13d2033a8`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about support and resistance.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Price level where the market can be expected to reverse to upside due to buying pressure.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Price level where the market can be expected to reverse to the downside due to selling pressure.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`They can occur on almost any indicator.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			<Text style={styles.bol}>{`Testing: `}</Text><></>
			<Text style={styles.reg}>{`When the price of an asset will go to a specific level in order to break or reject that specific price.  `}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			<Text style={styles.bol}>{`Breaking: `}</Text><></>
			<Text style={styles.reg}>{`An action in which a price of an asset goes through or “breaks” the support of resistance level.  `}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			<Text style={styles.bol}>{`Rejecting: `}</Text><></>
			<Text style={styles.reg}>{`When the price of an asset rebounds resistance level. `}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>	
			<Text style={styles.para}>
			{`Turn your attention to the screen (4:24), to see a visual demonstration of how to read support and resistance on a chart.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.italPara}>
			{`As you get more experience, you will gain a deeper understanding on how this works.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
