...
export default class orderbookmore6 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w8_6: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%208%2FOrderBook%2BMore.mp4?alt=media&token=bb7e78eb-ea37-4434-b839-5dcc6a0c3f06`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about order books, depth charts and the different types of orders.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`An order book is a list of buy and sell orders for a specific security organized by price level. `}
			</Text><></>
			<Text style={styles.para}>
			{`It is important because it provides valuable information by improving market transparency with price, availability, depth of trade, and those who initiate the transaction.  `}
			</Text><></>
			<Text style={styles.para}>
			{`The price indicates the financial security in which we are trading (BTC price in USDT) `}
			</Text><></>
			<Text style={styles.para}>
			{`The amount indicates the financial security that is being bought (in green) or sold (in red) `}
			</Text><></>
			<Text style={styles.para}>
			{`The total is the price multiplied by the amount.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`It is important to use because it represents supply and demand of a particular cryptocurrency.  `}
			</Text><></>
			<Text style={styles.para}>
			{`It shows the supply and demand point of your asset, showing exactly how much of an asset you can sell/ buy at a price point.  `}
			</Text><></>
			<Text style={styles.para}>
			{`The left side shows the buy orders or bids. The right side shows the sell orders or asks.  `}
			</Text><></>
			<Text style={styles.para}>
			{`The x-axis shows the USDT price and the y-axis shows the amount of each asset that is being sold or bought (amount of BTC). `}
			</Text><></>
			<Text style={styles.para}>
			{`You see a shaded chart, but this chart represents a collective of imaginary lines that indicates the total amount of bids/asks for specific cryptocurrencies at a specific price point.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Market order: Buying or selling of an asset at the market's best available price. `}
			</Text><></>
			<Text style={styles.para}>
			{`Limit: Buying or selling order of an asset with a safety net at a max paid price and a min received price.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Stop: Buying or selling of an asset at a market price in which the specific asset has traded through or at a specific “stop” price. The order is not executed if the asset does not reach this stop price.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Turn your attention to the screen (4:10) to see what this looks like.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
