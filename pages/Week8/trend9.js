...
export default class trend9 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w8_9: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%208%2FTrendlinesAndPatterns.mp4?alt=media&token=a26e5563-70d3-445d-a0ef-efa0ee6b302b`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be discussing trend lines and patterns; if you have not watched the “support and resistance” video, go back and watch it- it builds into this video.  `}
			</Text><></>
			<Text style={styles.para}>
			{`In order to understand the content in this video,  I recommend watching it.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Let’s get into it.  `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`It is based in support and resistance level `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What is it? `}
			</Text><></>
			<Text style={styles.para}>
			{`A line drawn on a chart that visually represents the direction of the movement of an asset; it is a sloping support or resistance.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`Why is it useful? `}
			</Text><></>
			<Text style={styles.para}>
			{`It shows a trend. Universal in both logarithmic and linear charts.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.bolPra}>
			{`How do you use it? `}
			</Text><></>
			<Text style={styles.para}>
			{`Find the local/absolute max/min, then find the next local or absolute max/min; usually, the chart will touch this trend line multiple times.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`They act predominantly as zones rather than a single line.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Draw trend lines based on candle bodies or wicks (not at the same time).  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`They are known as continuation patterns because when they form they show that a trend leads into a pattern and continues the pattern.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`They are also known by “consolidation patterns” because the markets will start to bounce off the pattern lines that represent the support and resistance.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` \u2022 Downward sloping resistance and upward sloping support.  `}
			</Text><></>
			<Text style={styles.para}>
			{` \u2022 Will happen more often than both the descending triangle pattern and ascending triangle pattern. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` \u2022 Downward sloping resistance and flat level of support `}
			</Text><></>
			<Text style={styles.para}>
			{` \u2022 You will more than likely see a bearish break in a descending triangle pattern. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{` \u2022 Flat top of resistance and an upward sloping support `}
			</Text><></>
			<Text style={styles.para}>
			{` \u2022 You will more than likely see a bullish breakout in an ascending triangle pattern. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.italPara}>
			{`Keep in mind, these patterns are highly situational; however, they can be indicators to make profitable trades because the end of a triangle pattern usually signifies a breakout.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Wedges break opposite because the market is losing momentum in that direction, as the support and resistance are trending in the same direction.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Pennants continue in the same direction because the markets are maintaining a healthy amount of resistance and support in order to continue the pattern. They both can be bullish or bearish.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
