...
export default class candle7 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w8_7: true})
        		})
        		batch.commit().then(() => {
	...
	return(
				...
				{'Candlestick Function Variation and Analysis'}
				</Text>
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%208%2FCandlestickFunction%2CVariation%2CandAnalysis.mp4?alt=media&token=90fceb59-38ed-49a3-ad5a-75aacd9fde0b`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.orderbookmore6()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about candlestick function variation and analysis. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Technical tool used for analysis in order to display specific data such as the days, highs, lows, etc. for a specific duration of time.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`Why use it? `}
			</Text><></>
			<Text style={styles.para}>
			{`Because it shows a list of intrinsic data points typically absent on line graphs. `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What specific data does it show? `}
			</Text><></>
			<Text style={styles.para}>
			{`It shows the open price, close price, direction of the market, and the absolute highs and lows of that specific period.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Two candlesticks side by side: bullish has red then green; bearish has green then red. `}
			</Text><></>
			<Text style={styles.para}>
			{`The first candlestick is almost always smaller than the second by a magnitude of 2 ( there are exceptions).   `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What does it signify? `}
			</Text><></>
			<Text style={styles.para}>
			{`Signals lower prices to come (bearish) or higher prices to come (bullish).  `}
			</Text><></>
			<Text style={styles.para}>
			{`Indicates that buyers are overtaken by sellers (bearish) or vice versa (bullish). `}
			</Text><></>
			<Text style={styles.italPara}>
			{`When does it usually occur? `}
			</Text><></>
			<Text style={styles.para}>
			{`Top of an uptrend (bearish). Bottom of a downtrend (bullish).  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Candlestick shows the price went up to a high absolute maximum with a ling upward wick; but, it went back down to the same closing of the previous candlestick (can be both red or green).  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What does it signify? `}
			</Text><></>
			<Text style={styles.para}>
			{`The transitioning of power from the bulls to the bears.  `}
			</Text><></>
			<Text style={styles.para}>
			{`It is a really strong indicator and it is more rare than the engulfing pattern.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`When does it usually occur? `}
			</Text><></>
			<Text style={styles.para}>
			{`It usually occurs at the end of an uptrend.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Candlestick shows the price went down to a low absolute minimum with a long downward wick, but then went back up to the same closing of previous candlestick. Looks like a hammer.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What does it signify? `}
			</Text><></>
			<Text style={styles.para}>
			{`Transitioning of power from the bears to the bulls. `}
			</Text><></>
			<Text style={styles.para}>
			{`Very strong indicator and it is more rare than the engulfing pattern.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`When does it usually occur? `}
			</Text><></>
			<Text style={styles.para}>
			{`It usually occurs at the end of a downtrend. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Three red consecutive candlesticks.  `}
			</Text><></>
			<Text style={styles.para}>
			{`All of them are relatively the same size, no upward wicks shows a bearish trend.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What does it signify? `}
			</Text><></>
			<Text style={styles.para}>
			{`A very strong bearish trend. `}
			</Text><></>
			<Text style={styles.italPara}>
			{`When does it usually occur? `}
			</Text><></>
			<Text style={styles.para}>
			{`It usually occurs at the beginning or middle of a downward trend. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Three green consecutive candlesticks.  `}
			</Text><></>
			<Text style={styles.para}>
			{`All of them are relatively the same size, no downward wick shows a bullish trend.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What does it signify? `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`It usually occurs at the beginning or middle of a bullish trend. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Body can be green or red. The wick in both bottom and top are relatively the same size.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Longer wicks mean more indecision with more volatile price action.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`What does it signify? `}
			</Text><></>
			<Text style={styles.para}>
			{`Indecision and tension in the markets. Bulls and bears are competing for dominance.  `}
			</Text><></>
			<Text style={styles.italPara}>
			{`When does it usually occur? `}
			</Text><></>
			<Text style={styles.para}>
			{`It usually can happen a potential trend reveal for both bearish and bullish scenarios.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`That is it for candlestick analysis, those are the types that are standard in my technical analysis.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Make sure you are understanding this because it is very important. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
