...
export default class moreprodquest8 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w6_8: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%206%2FMoreProductQuestions.mp4?alt=media&token=36584e6d-1bfc-49ca-8942-4b8e1c915da6`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.w7booklist()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be wrapping up the product section.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Hopefully, you've been researching the coin you're interested in and using it for yourself.  `}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			{`Understanding if the project is useful  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Does the project have a unique attribute to penetrate the market? `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Is it detailed, easy to understand and accurate? `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Does it have a consensus mechanism? `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Hopefully you all have a structure created to help you research. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			<Text style = {styles.reg}>{`Token Metrics: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://tokenmetrics.com/?ref=alexanderlorenzo1`)}>{`https://tokenmetrics.com/?ref=alexanderlorenzo1`}</Text><></>
			</Text><></>
			<Text style={styles.para}>
			<Text style = {styles.reg}>{` Crypto Miso: `}</Text><></>
			<Text style = {styles.regURL}
			onPress={() => Linking.openURL(`https://www.cryptomiso.com/`)}>{`https://www.cryptomiso.com/`}</Text><></>
			</Text><></>
