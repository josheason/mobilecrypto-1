...
export default class valueprop7 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w6_7: true})
        		})
        		batch.commit().then(() => {
	...
	return(
				...
				{'Value Proposition Of a Project'}
				</Text>
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%206%2FValuePropositionOfaProject.mp4?alt=media&token=d93292ad-c180-447a-b444-da0a4c2d60a9`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.conmech6()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today I will be giving you a brief understanding of value proposition and how to find it within a cryptocurrency. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Value Proposition is an innovation, service or feature intended to make a product attractive to customers.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`For example: Let’s say I wanted to create a running shoe. `}
			</Text><></>
			<Text style={styles.para}>
			{`If I wanted to enter this market, I would have to create something unique to stand out against the competition. There are many ways to win in business, but there has to be a niche. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`We are going to look into the whitepaper to find the value proposition of a coin.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Let’s take a look at the Bitcoin whitepaper.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Essentially we are looking for what sets Bitcoin aside from other currencies; what makes them unique.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Bitcoin proposes the BAT system as a token of exchange in a secure, anonymous, opt-in advertising system. This helps users, publishers and advertisers.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`This is why going through a whitepaper is so important; you will find the value proposition among other things about the cryptocurrency. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
