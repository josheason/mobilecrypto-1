...
export default class corpgov7 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w5_7: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%205%2FCorporateGovernance.mp4?alt=media&token=3949b660-8ef8-49d0-af70-351dbe65c9fc`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.partnerships6()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be talking about corporate governance; we will go into detail when it comes to leaders and partners of a company to figure out their character. `}
			</Text><></>
			<Text style={styles.para}>
			{`Corporate governance  is a term used to describe the levels of power within an organization.  `}
			</Text><></>
			<Text style={styles.para}>
			{`It safeguards the company to make sure that management is acting in the best interest of the shareholders. `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`In a company, these are the individuals we pay attention to:  `}
			</Text><></>
				
			<Text style={styles.para}>
			<Text style = {styles.bol}>{`Owners: `}</Text><></>
			<Text style = {styles.reg}>{`Chief Marketing Officer, Chief Technology Officer, Chief Executive Officer`}</Text><></>
			</Text><></>
				
			<Text style={styles.para}>
			<Text style = {styles.bol}>{`Advisors: `}</Text><></>
			<Text style = {styles.reg}>{`Anyone involved with the company`}</Text><></>
			</Text><></>
				
			<Text style={styles.para}>
			<Text style = {styles.bol}>{`Lead workers: `}</Text><></>
			<Text style = {styles.reg}>{`Lead developer, social media manager, head of business`}</Text><></>
			</Text><></>
			...
			<Text style={styles.para}>
			{`When analyzing owners you must: `}
			</Text><></>
			<Text style={styles.para}>
			{`Ask yourself these questions: `}
			</Text><></>
			<Text style={styles.para}>
			{`   \u2022 Are they receiving excessive compensation? `}
			</Text><></>
			<Text style={styles.para}>
			{`   \u2022 Does their background match their position? `}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			{`   \u2022 Check court documents, legal skirmishes, divorce papers.  `}
			</Text><></>
			<Text style={styles.para}>
			{`   \u2022 Make sure they are not spreading themselves thin. `}
			</Text><></>
			<Text style={styles.para}>
			...
			<Text style={styles.para}>
			{`Remember, you are investing in a company, but you can not make the decisions. So, you must find charter flaws to save your investment.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
