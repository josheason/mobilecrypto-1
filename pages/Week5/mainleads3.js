...
export default class mainleads3 extends Component{
   		...
   		watchedRef.where('id', '==', user.uid)
     		 ...
     		 .get().then(response => {
        		...
        		response.docs.forEach((doc) => {
            		...
            		batch.update(docRef, {watched: increment , w5_3: true})
        		})
        		batch.commit().then(() => {
	...
	return(
			...
			source={{ uri: `https://firebasestorage.googleapis.com/v0/b/mobilecrypto-b1543.appspot.com/o/Week%205%2FMainLeaders.mp4?alt=media&token=8b0670f4-7054-4a17-a013-859562379025`}}
			rate={1.0}
			volume={1.0}
			isMuted={false}
			resizeMode="cover"
	...
	//		posterResizeMode={'contain'}
			...
			/><></>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.w5booklist2()}>
				...
				<TouchableOpacity activeOpacity={0.3} underlayColor="#6200ee" onPress={() => Actions.repu4()}>
		...
		>{
			...
			<Text style={styles.para}>
			{`Today we will be checking the credibility of the leaders and team members of a coin.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Go to coinmarketcap.com, pick any coin. Let’s say EOS. `}
			</Text><></>
			<Text style={styles.para}>
			{`Go on the EOS website → About us. (We are looking for the leaders)  `}
			</Text><></>
			<Text style={styles.para}>
			{`The leaders won’t always be on the website, in that case Google it. `}
			</Text><></>
			<Text style={styles.para}>
			{`By doing so, we find that EOS was launched by Dan Larimer.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`When looking at a CEO, you want to find one who has a technology background.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`So, let’s look at his history. `}
			</Text><></>
			<Text style={styles.para}>
			{`He is a software programmer and cryptocurrency entrepreneur and created two blockchains already. This is a good sign because it shows he has created blue oceans.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			...
			<Text style={styles.para}>
			{`Blue ocean strategy: They come with new content. For example: Google, YouTube, Facebook; these create the ocean.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Red ocean strategy: Typically competing against others. For example: insurance. These agencies are fighting over the same customers. They are competing for customers. Competition based company.  `}
			</Text><></>
			<Text style={styles.para}>
			{`In a leader, we are looking for guys like Elon Musk who create new material.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Now, let’s look at another coin; let’s say Cortex.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Go on the Cortex website → Click on core team `}
			</Text><></>
			<Text style={styles.para}>
			{`Take a look at the CEO: Ziqi Chen  `}
			</Text><></>
			<Text style={styles.para}>
			{`He created “Waterhole,” let's go on the website and look around; to make sure it is legit.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Next, let’s go on his Linkedin; looking at his work history, we can see he has a well-versed background. `}
			</Text><></>
			<Text style={styles.para}>
			{`I would give him a 9/10; as he is involved in many business ventures.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Now, let’s look at the other team members; it is important that everyone has a legit background.  `}
			</Text><></>
			<Text style={styles.para}>
			{`The CTO & Chief Scientist on the team is Jia Tian;  he has a very good background as well.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Let’s research another coin, Telcoin.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Look for the CEO: Claude Eguienta.  `}
			</Text><></>
			<Text style={styles.para}>
			{`Looking at Claude's history, his business ventures do not look promising.  `}
			</Text><></>
			<Text style={styles.para}>
			{`After research, Telcoin is not a coin I would put all of my trust in.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
			<Text style={styles.para}>
			{`Ultimately, you all must understand the importance of researching a team and knowing the difference between a good and a bad team.  `}
			</Text><></>
			<Text style={styles.para}>
			{` `}
			</Text><></>
